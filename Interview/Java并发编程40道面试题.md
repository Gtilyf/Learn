...
[https://zhuanlan.zhihu.com/p/58265081?utm_source=qq&utm_medium=social&utm_oi=58097666097152](https://zhuanlan.zhihu.com/p/58265081?utm_source=qq&utm_medium=social&utm_oi=58097666097152)
...
**12、什么是FutureTask?使用ExecutorService启动任务。**
...
![](https://pic3.zhimg.com/80/v2-23ab3fcf4027ae7264466681d82a11f6_1440w.jpg)
...
**31、Java中ConcurrentHashMap的并发度是什么？**
...
**35、Java中的ReadWriteLock是什么？**

读写锁是用来提升并发程序性能的锁分离技术的成果。

**36、volatile 变量和 atomic 变量有什么不同？**
...
**38、什么是Java Timer 类？如何创建一个有特定时间间隔的任务？**
